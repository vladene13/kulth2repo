      ...
      <header className="min-w-full mt-6">
        <nav className="h-full p-1 flex items-center justify-between max-sm:items-end relative z-10">
          <div className="flex items-end">
            <img src={brand} alt="brand heydra" className="h-28 w-30" />
            <img
              src={brandName}
              alt="brand hyedra name"
              className="h-50 w-20 ml-0"
            />
          </div>
          <ul className="text-white text-xs font-montserrat-bold flex gap-10 max-sm:hidden">
            <NavLink to="#about">ABOUT</NavLink>
            <NavLink to="#services">PRODUCT</NavLink>
            <NavLink to="#services2">ROADMAP</NavLink>
          ...
          <div className="flex font-montserrat-bold gap-9 items-end max-lg:hidden">
            ...
            <a
              href="#join"
              className="text-primary text-sm font-montserrat-bold h-[48px] w-[154px] bg-gradient-to-r from-linear-two to-linear-two no-underline rounded-full flex justify-center items-center"
            >
              LOG IN
            </a>
          </div>
