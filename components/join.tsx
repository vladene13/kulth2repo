...
export default function Join() {
  return (
    <section className="mt-28" id="join">
      <div className="bg-gradient-to-b from-radial-one via-radial-one to-radial-two rounded-[100px] flex justify-center items-center flex-col py-[90px] px-24 max-sm:px-5 max-sm:rounded-[40px] max-sm:py-11">
        <div className="text-center">
          ...
          <p className="text-4xl text-slate-300 font-light mt-5 max-sm:text-2xl">
            Let's Build <span className="max-sm:block">Your XR&AI Experience</span>
          </p>
        </div>
